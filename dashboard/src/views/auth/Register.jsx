...
import { FaGoogle } from "react-icons/fa";    // Importing icons for UI
    ...
    <div className="min-w-screen min-h-screen bg-[#cdcae9] flex justify-center items-center">
      <div className="w-[350px] text-[#ffffff] p-2">
          ...
          <form onSubmit={submit}>
            <div className="flex flex-col w-full gap-1 mb-3">
              ...
              <input onChange={inputHandle} value={state.name}
                className="px-3 py-2 outline-none border border-slate-700 
        ...
        bg-transparent rounded-md"
            ...
            <button
              className="bg-slate-800 w-full hover:shadow-blue-300/
